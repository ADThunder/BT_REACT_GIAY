...
import ShoesStoreItem from './ShoesStoreItem'
  ...
  render() {
    return (
      <div className='container py-5'>
        <h1 style={{ fontSize: "30px", color: "Red" }} className="text-center fw-bold pb-3">Shoes shop</h1>
        <div className="row">
          <div className="col-8">
            <div className="row">
              {this.arrGiay.map((item, index) => {
                return <div style={{paddingBottom : "20px"}} className="col-4" key={index}>
                  <ShoesStoreItem clickXemGiay={this.thongTinChiTietGiay} giay={item} />
                </div>
              })}
            </div>
          </div>
          <div className="col-4">
            <ShoesDetail detailGiay={this.state.giay}/>
          </div>
        </div>
      </div>
    )
